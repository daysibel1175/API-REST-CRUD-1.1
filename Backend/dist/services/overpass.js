...
exports.normalizeOverpassElement = normalizeOverpassElement;
exports.fetchOverpassTrilhas = fetchOverpassTrilhas;
const DEFAULT_OVERPASS_URL = process.env.OVERPASS_API_URL ?? "https://overpass-api.de/api/interpreter";
...
async function fetchOverpassTrilhas() {
    ...
    if (!response.ok) {
        ...
        throw new Error(`Overpass respondeu com status ${response.status} ${response.statusText}. Resposta: ${errorBody.slice(0, 300)}`);
    }
