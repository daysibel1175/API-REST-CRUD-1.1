...
async function popularBancoDeDados() {
    try {
        ...
        await usuario_1.default.updateOne({ _id: usuarios[0]._id }, { grupo: grupos[0]._id });
        await usuario_1.default.updateOne({ _id: usuarios[1]._id }, { grupo: grupos[0]._id });
        await usuario_1.default.updateOne({ _id: usuarios[2]._id }, { grupo: grupos[1]._id });
        await usuario_1.default.updateOne({ _id: usuarios[3]._id }, { grupo: grupos[2]._id });
        await usuario_1.default.updateOne({ _id: usuarios[4]._id }, { grupo: grupos[1]._id });
