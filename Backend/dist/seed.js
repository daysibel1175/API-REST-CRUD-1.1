        ...
        const trilhas = await trilhas_1.default.insertMany([
            {
                ...
                descricao: "Pico mais alto da Serra dos Órgãos (2.275 m). Subida longa e técnica com trechos íngremes.",
            ...
            },
            {
                ...
                tipo_de_trilha: "Difícil",
                descricao: "Travessia de cerca de 27–30 km, realizada em 2–3 dias; terreno variado e trechos expostos.",
                localizacao: "Serra dos Órgãos - Rio de Janeiro",
            ...
            },
            {
                ...
                tipo_de_trilha: "Difícil",
                descricao: "Rota de aproximadamente 15 km com trechos técnicos e possibilidade de pernoite em campo.",
                localizacao: "Serra dos Órgãos - Rio de Janeiro",
            ...
            },
            {
                ...
                descricao: "Curta (2,7 km) com mirante para o Dedo de Deus, trecho pedregoso perto do final.",
                localizacao: "Serra dos Órgãos - Rio de Janeiro",
            ...
            },
            {
                nome: "Pico da Tijuca",
                tipo_de_trilha: "Difícil",
                descricao: "Rota de subida ao ponto mais alto do Parque Nacional da Tijuca com vistas panorâmicas da cidade.",
            ...
            },
            {
                ...
                tipo_de_trilha: "Difícil",
                descricao: "Caminhada de cerca de 9,3 km que termina no monumento do Cristo Redentor; subida constante.",
                localizacao: "Parque Nacional da Tijuca - Rio de Janeiro",
            ...
            },
            {
                nome: "Pedra Bonita",
                tipo_de_trilha: "Moderada",
                descricao: "Trilha curta (3,4 km) com mirante famoso, visão para São Conrado e a orla.",
                localizacao: "Parque Nacional da Tijuca - Rio de Janeiro",
            ...
            },
            {
                ...
                tipo_de_trilha: "Moderada",
                descricao: "Caminho por rios e grutas até uma bela cachoeira dentro da Tijuca.",
                localizacao: "Parque Nacional da Tijuca - Rio de Janeiro",
            ...
            },
            {
                ...
                tipo_de_trilha: "Difícil",
                descricao: "Percurso costeiro de 16 km ligando praias isoladas como Bonete e Cedro; variação de terreno.",
            ...
            },
            {
                ...
                tipo_de_trilha: "Moderada",
                descricao: "Caminhada de 5,8 km até praia de águas cristalinas, com trechos de mata e costão.",
                localizacao: "Ubatuba - São Paulo",
            ...
            },
            {
                ...
                tipo_de_trilha: "Moderada",
                descricao: "Caminho costeiro de 4 km pela Mata Atlântica entre praias cenográficas.",
                localizacao: "Ubatuba - São Paulo",
            ...
            },
            {
                ...
                descricao: "Rota curta (2,3 km) que combina praia e cachoeira, ideal para quem busca passeio leve.",
                localizacao: "Ubatuba - São Paulo",
            ...
            },
            {
                ...
                tipo_de_trilha: "Fácil",
                descricao: "Caminhada de 4,7 km dentro do Horto Florestal, cachoeira de fácil acesso.",
            ...
            },
            {
                ...
                tipo_de_trilha: "Fácil",
                descricao: "Curta (2 km) com pontes suspensas e trechos de mata rasteira; passeio tranquilo.",
                localizacao: "Campos do Jordão - São Paulo",
            ...
            },
            {
                ...
                descricao: "Subida de 3 km com bela vista do Vale do Paraíba; em dias claros vê-se várias cidades.",
                localizacao: "Campos do Jordão - São Paulo",
            ...
            },
            {
                nome: "Pedra do Baú",
                tipo_de_trilha: "Difícil",
                descricao: "Formação rochosa a 1.950 m que exige trilha e trechos de escalada; experiência técnica recomendada.",
                localizacao: "Campos do Jordão (região de São Bento do Sapucaí) - São Paulo",
